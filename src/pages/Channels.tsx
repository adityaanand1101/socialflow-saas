...
const ALL_PLATFORMS = [
  ...
  { id: 'wordpress', label: 'WordPress', icon: WordPress, color: 'text-blue-500', bgHover: 'hover:border-blue-500/50 hover:bg-blue-500/5', description: 'Blogs & Articles', authNote: 'Requires WordPress.com REST API OAuth' },
